...
\inlinetodo{%
  Conduct the proof ``on paper'' first, and then show the mechanization with
  Harpoon?%
}
...
% normalization using
%using reducibility candidates
%\cite{GirardLafontTaylor:proofsAndTypes}. In essence, we define
...
% over the closed term \lstinline!N! of type \lstinline!T1!.

...
\newcommand{\basicitrans}{\ensuremath\longleadsto{0.85}}
...
\newcommand{\declarejudgment}[2]{%
  \begin{tabular}{>{\centering\arraybackslash}m{0.35\linewidth}m{0.649\linewidth}}
    #1 & #2
  \end{tabular}%
}
